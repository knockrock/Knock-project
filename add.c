...
void init_M_node(movie ** M_L, m_node * newnode) // 처음 movie 노드 리스트에 연결
{
...
void init_D_node(director ** D_L, d_node * newnode) //처음 director 노드 리스트에 연결
{
...
void init_A_node(actor ** A_L, a_node * newnode) //처음 actor 노드 리스트에 연결
{
